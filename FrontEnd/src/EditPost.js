    ...
    if(props.flag)
    {
        return (
            <div>
                ...
                <textarea className="create_input" rows="10" cols="40" value={content} onChange={handleContent} placeholder="Content"></textarea>
                <button className="edit_button" onClick={post}>Post</button>
            </div>
        )
    }
    else
